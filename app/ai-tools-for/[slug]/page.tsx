      ...
      <>
        ...
        <main className="max-w-3xl mx-auto px-4 py-10">
          ...
          <div className="bg-black text-white rounded-2xl p-6 text-center">
            ...
            <Link href="/toolkits" className="inline-block bg-white text-black px-5 py-2 rounded-xl text-sm font-medium hover:bg-gray-100 transition-colors">View Pricing →</Link>
          </div>
        </main>
      </>
    );
