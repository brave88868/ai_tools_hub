...
export const metadata: Metadata = {
  title: "AI Tools Station — 400+ Free AI Tools for Real Workflows",
  description:
    "Generate resumes, marketing copy, YouTube scripts, business plans and more with 400+ free AI tools. Start free, no credit card required.",
};
