...
export const metadata: Metadata = {
  title: "AI Tools Station — 500+ Free AI Tools for Real Workflows",
  description:
    "Generate resumes, marketing copy, YouTube scripts, business plans and more with 500+ free AI tools. Start free, no credit card required.",
};
