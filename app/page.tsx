...
export const metadata: Metadata = {
  title: "AI Tools Station — 550+ Free AI Tools for Real Workflows",
  description:
    "Generate resumes, marketing copy, YouTube scripts, business plans and more with 550+ free AI tools. Start free, no credit card required.",
};
